...
& (Join-Path $RepoRoot 'scripts\install-gamepad-bridge-autostart.ps1')

Write-Host ''
Write-Host 'In-game or pause: Ctrl+Shift+O OR hold LT + click L3+R3 (Xbox)' -ForegroundColor Green
